...
import ModalBundesliga from '../components/Modal/modalBundesliga';
...
function Alemao() {
  ...
  useEffect(() => {
    fetch('http://127.0.0.1:5000/api/v1/bundesliga/', {
      method: 'GET',
      mode: 'cors'
    })
    .then(res => {
  ...
  return (
    <main className='container-table'>
      <div className='content-table'>
        ...
        <ModalBundesliga titulo={modal} index={index} />
      </div>
    </main>
