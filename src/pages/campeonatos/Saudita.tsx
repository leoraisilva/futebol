...
import ModalSaudita from '../components/Modal/modalSaudita';
...
function Saudita() {
  ...
  useEffect(() => {
    fetch('http://127.0.0.1:5000/api/v1/saudita/', {
      method: 'GET',
      mode: 'cors'
    })
    .then(res => {
  ...
  return (
    <main className='container-table'>
      <div className='content-table'>
        ...
        <ModalSaudita titulo={modal} index={index} />
        </div>
    </main>
