...
interface ModalPremierProps {
    titulo: string;
  }
  
  function ModalPremier({ titulo }: ModalPremierProps) {
  
    const [jogos, setJogos] = useState<any[]>([]);
  
    useEffect(() => {
      fetch('http://127.0.0.1:5000/api/v1/jogos/premier-league/', {
        method: 'GET',
        mode: 'cors',
      })
        .then((res) => {
