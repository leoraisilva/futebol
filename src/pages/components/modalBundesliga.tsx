...
interface ModalBundesligaProps {
    titulo: string;
  }
  
  function ModalBundesliga({ titulo }: ModalBundesligaProps) {
  
    const [jogos, setJogos] = useState<any[]>([]);
  
    useEffect(() => {
      fetch('http://127.0.0.1:5000/api/v1/jogos/bundesliga/', {
        method: 'GET',
        mode: 'cors',
      })
        .then((res) => {
  ...
  export default ModalBundesliga;
